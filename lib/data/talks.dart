...
List<TalkTitleItem> Day2 = [
  ...
  TalkTitleItem(
      "Line's Main, Line Work, Flipping Ribbons, Glass Personified",
      'Jack Gramann',
      'Berlin Glas',
      'DEMO',
      'HOT',
      ...
      'https://www.jackgramannglass.com',
      'jackgramann',
      '',
  ...
  TalkTitleItem(
      ...
      'https://www.jahdayfordglass.co.uk/',
      'jahdayfordesign',
      '',
  ...
  TalkTitleItem(
      'Silkscreening and Roll-Up Demo',
      ...
      'http://www.claudiavitari.com',
      'claudia_virginia_vitari',
  ...
  TalkTitleItem(
      ...
      'DEMO',
      'HOT',
      'During this demonstration, artist Jinya Zhao and the glassblowing team explore the profound '
          'connections that blown glass sculpture can create between maker and viewer, drawing on '
          'memories and sparking the imagination. Jinya&#39;s work delves into the expressive potential of '
          'glass, harnessing its qualities of colour, obscurity, revelation, and form to embody themes of '
          'emotion and personal experience. This session invites attendees into a visual and tangible '
          'exploration of memory and form, offering attendees the unique opportunity to witness the '
          'transformative process of glassblowing as personal recollections are shaped in real time.',
  ...
  TalkTitleItem(
      'Mediterranean Gems: Heritage Meets Contemporary Glass Design',
      'Mert Ungor',
      'Berlin Glas',
      'DEMO',
      'HOT',
  ...
  TalkTitleItem(
      'Something Old for Something New - Translating of Venetian Technique from the Renaissance into Borosilicate Glass',
      'Simone Crestani',
      'Wilhelm Hallen Flame Shop',
      'DEMO',
      'FLAME',
  ...
  TalkTitleItem(
      'Sculptural Recycled Glass Flameworking',
      'Ivan Bestari',
      'Wilhelm Hallen Flame Shop',
      'DEMO',
      'FLAME',
      ...
      'https://www.deviantart.com/ivan12',
      'ivanoozz',
      '',
      DateTime.parse('2024-05-17 14:00:00Z'),
      DateTime.parse('2024-05-17 15:30:00Z'),
  ...
  TalkTitleItem(
      'Dialogue of Wheels, Contemporary Glass Engraving',
      'Ioana Stelea',
  ...
  TalkTitleItem(
      'Lathe Riders - International Cold Working',
      'Lothar Bottcher',
      'Wilhelm Hallen Cold Shop',
      'DEMO',
      'COLD',
  ...
  TalkTitleItem(
      'Design or Art? Creating of 3D Sculptures in Glass Fusing Technique',
      'Marta Gibiete',
      'Wilhelm Hallen Cold Shop',
      'LECMO',
      'KILN',
  ...
  TalkTitleItem(
      'Practical Magic: Now You See It...',
      'Nate Ricciuto',
      'Berlin Glas Lecmo',
      'LECMO',
      'KILN',
  ...
  TalkTitleItem(
      'Is it a window or not? Unconventional and contemporary ways of using stained and flat glass in design and art.',
      'Aaron Peters',
      'Wilhelm Hallen Cold Shop',
      'LECMO',
      'KILN',
  ...
  TalkTitleItem(
      'Laziness, mother of creativity? How I had to create new ways of working in order to adapt to my creative space: physical and mental.',
      'Ricardo Hoineff',
      'Berlin Glas Lecmo',
      'LECMO',
      'KILN',
  ...
  TalkTitleItem(
      'Freeze Casting with Borosilicate Glass',
      'Carrie Strope',
      'Berlin Glas Lecmo',
      'LECMO',
      'KILN',
  ...
  TalkTitleItem(
      'From Papier-Mâché to Pâte de Verre',
      'Saman Kalantari',
      'Berlin Glas Lecmo',
      'LECMO',
      'KILN',
      'Kalantari will demonstrate his distinctive and innovative methods for creating pâte de '
          ...
          'well-being.',
      'http://www.samankalantari.art',
      'saman_kalantari_glass',
      '',
      DateTime.parse('2024-05-16 16:00:00Z'),
      DateTime.parse('2024-05-16 17:30:00Z'),
      false),
  ...
  TalkTitleItem(
      'Intergalactic, Intergenerational, Bead Weaving',
      'Adeye Jean-Baptiste',
      'Wilhelm Hallen Cold Shop',
      'LECMO',
      'KILN',
  ...
  TalkTitleItem(
      'Digital Workflows for Reusable Hot Shop Molds',
      'Brian Gillespie',
      'Berlin Glas Lecmo',
      'LECMO',
      'MOLD',
  ...
  TalkTitleItem(
      'Patternwork of the American Glass Pipe Movement',
      'Christopher McElroy',
      'Wilhelm Hallen Main Stage',
      'LECTURE',
      'HISTORY',
  ...
  TalkTitleItem(
      'CAD and Glass Integration',
      'Ryan Kuhns',
      'Provinstrase Lecture',
      'LECTURE',
      'TECHNOLOGY',
  ...
  TalkTitleItem(
      'Glass: Hand Formed Matter; Perspectives of Manual Glass Making in Europe',
      'Barbara Schmidt',
      'Provinstrase Lecture',
      'LECTURE',
      'COMMUNITY',
  ...
  TalkTitleItem(
      'Translucent Narratives: A Journey through Romanian Glass Art.',
      'Alexandra Muresan',
      'Provinstrase Lecture',
      'LECTURE',
      'HISTORY',
      ...
      'https://www.instagram.com/alexandramuresanglass',
      'alexandramuresanglass',
      '',
      DateTime.parse('2024-05-16 10:00:00Z'),
      DateTime.parse('2024-05-16 11:00:00Z'),
      false),
  ...
  TalkTitleItem(
      'Addressing the Past through a Glass Lens',
      'Alison Lowry',
      'Provinstrase Lecture',
      'LECTURE',
      'SOCIAL JUSTICE',
  ...
  TalkTitleItem(
      'PANEL: Saxe Emerging Artists',
      'Saxe Emerging Artist Awardees',
      'Wilhelm Hallen Main Stage',
      'PANEL',
      '',
  ...
  TalkTitleItem(
      'How we Built the Heavies Glass Sculpture in World (probably)',
      'Daniel Kvesic',
      'Provinstrase Lecture',
      'LECTURE',
      'TECHNOLOGY',
  ...
  TalkTitleItem(
      'Why Glassblowing is Irrelevant',
      'John Dillard',
      'Provinstrase Lecture',
      'LECTURE',
      'HISTORY',
  ...
  TalkTitleItem(
      'Traditional and non-traditional methods of imagery on glass',
      'Chuchen Song',
      'Berlin Glas Lecmo',
      'LECMO',
      'KILN',
  ...
  TalkTitleItem(
      'Endangered Status - The Current Situation for Stained Glass in the UK',
      'Sarah Rothwell',
  ...
  TalkTitleItem(
      'Fostering Creativity and Learning: Exploring the Impact of Nonaccredited Education '
  ...
  TalkTitleItem(
      'Crafting Calm - Discussion and Strategies on How to Keep Sane as a Glass Artist',
      'Charlott Rodgers',
      'Wilhelm Hallen Panel',
      'PANEL',
      'MENTAL HEALTH',
  ...
  TalkTitleItem(
      'The Glass Virus: On the Hybrid II',
      'Gayle Matthias',
      'Wilhelm Hallen Panel',
      'PANEL',
      'EDUCATION',
      'The Glass Virus, a Think Tank for educational strategies, aims to reach a greater understanding '
          ...
          'participants.',
      'https://www.theglassvirus.com/about',
      'gayle.matthias',
  ...
  TalkTitleItem(
      'Creating Training and Networking Opportunities to Support Emerging Glass Makers',
      'Sarah Hochstetter',
      'Wilhelm Hallen Panel',
      'PANEL',
      'CAREER',
  ...
  TalkTitleItem(
      'Melting Tension - The Benefits of Massage for Glassblowers',
      'Hannah Guisewhite',
  ...
  TalkTitleItem(
      ...
      'https://emiliamarcjasz.webador.com/',
      'emilia.marcjasz',
      '',
  ...
  TalkTitleItem(
      'Diamond point engraving with AI design',
      'Healy Arts',
      'Wilhelm Hallen Cold Shop',
      'WORKSHOP',
      '',
